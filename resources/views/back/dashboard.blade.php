        ...
        <div class="admin-nav">
            <ul class="">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li> <a href="{{route('cons')}}"><i class="sl-icon-envelope-open "></i><span class="admin-nav-text">وقت مشاوره</span></a></li>
                        <li> <a href="{{route('eval')}}"><i class="sl-icon-envelope-open "></i><span class="admin-nav-text">ارزشیابی</span></a></li>
                    </ul>
                </li>
                <li>
